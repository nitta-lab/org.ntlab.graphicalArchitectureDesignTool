...
public class DataFlowModelTest {
	...
	public void test() {
		...
		//
		DataflowChannelGenerator gin_1 = new DataflowChannelGenerator("gin_1");	// set customer's office (an input channel)
		...
		//
		DataflowChannelGenerator gin_2 = new DataflowChannelGenerator("gin_2");	// set companie's address (an input channel)
		...
		//
		DataflowChannelGenerator g = new DataflowChannelGenerator("g");		// update customer's address
